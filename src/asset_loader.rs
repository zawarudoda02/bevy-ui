...
fn load_assets(mut commands: Commands,asset_server: Res<AssetServer>,mut atlases: ResMut<Assets<TextureAtlas>>){
    let atlas_handle = atlases.add(
        TextureAtlas::from_grid(asset_server.load(FILE_NAME),TILE_SIZE,COLUMNS,ROWS,None,None)
